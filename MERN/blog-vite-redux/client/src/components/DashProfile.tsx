...
const DashProfile = () => {
  ...
  const { currentUser, error } = useSelector((state: UserRedux) => state.user)
  ...
  const uploadImage = async () => {
    ...
    const uploadTask = uploadBytesResumable(storageReference, imageFile as Blob)
    uploadTask.on(
      'state_changed',
      (snapshot) => {
  ...
  return (
    <div className="max-w-lg mx-auto p-3 w-full">
      ...
      <form className="flex flex-col" onSubmit={handleSubmit}>
        ...
        {imageFileUploadError && <Alert color={imageFileUploadError} />}
        ...
        <Modal.Body>
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4">
              <Button color="failure" onClick={() => deleteAccount(_id ?? '')}>
                Yes, I'm sure
              </Button>
